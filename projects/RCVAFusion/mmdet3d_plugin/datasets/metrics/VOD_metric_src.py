...
from .kitti_official_eval import get_official_eval_result
...
class VODMetric_src(BaseMetric):
    ...
    def __init__(self,
        ...
        super(VODMetric_src, self).__init__(
        ...
        self.use_point_modality=use_point_modality
    ...
    def kitti_evaluate(self,
        ...
        for name in results_dict:
            ...
            evaluation_result.update(
                get_official_eval_result(gt_annos, results_dict[name],classes, custom_method=0))
            evaluation_result.update(
                get_official_eval_result(gt_annos, results_dict[name], classes, custom_method=3))
    ...
    def convert_valid_bboxes(self, box_dict: dict, info: dict) -> dict:
        ...
        # use another camera, please modify it.
        lidar2cam = np.array(
            info[self.use_point_modality[0]][self.use_point_modality[1]]).astype(
                np.float32)
