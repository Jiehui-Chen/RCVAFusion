...
class TJ4DRadSetDataset(Det3DDataset):
    r"""KITTI Dataset.
    ...
    def __init__(self,
                 ...
                 data_prefix: dict = dict(pts='TJ4DRadSet_4DRadar/training/velodyne', img='TJ4DRadSet_Non_Public/training/image_2'),
    ...
    def dynamic_baseline(self, info):
        ...
        # P3 = np.array(info['calib']['P3'].astype(np.float32)) # cam2img
    ...
    def parse_data_info(self, info: dict) -> dict:
        ...
        if self.modality['use_lidar']:
            ...
            info['lidar2cam'] = np.array(info['lidar_points']['Tr_velo_to_cam'])
