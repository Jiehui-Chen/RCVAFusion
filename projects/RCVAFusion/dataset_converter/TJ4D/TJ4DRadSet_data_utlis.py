...
def get_image_path(idx,
    ...
    img_idx_str = get_image_index_str(idx, use_prefix_id)
    img_idx_str += '.png'
    base_img = 'TJ4DRadSet_Non_Public/training/image_2'
...
def get_velodyne_path(idx,
    ...
    img_idx_str = get_image_index_str(idx, use_prefix_id)
    img_idx_str += '.bin'
    base_velodyne='TJ4DRadSet_4DRadar/training/velodyne'
    path=os.path.join(base_velodyne,img_idx_str)
    if relative_path:
        return path
    else:
        return os.path.join(prefix,path)
...
def get_calib_path(idx,
    ...
    img_idx_str = get_image_index_str(idx, use_prefix_id)
    img_idx_str += '.txt'
    base_calib='TJ4DRadSet_4DRadar/training/calib'
    path=os.path.join(base_calib,img_idx_str)
    if relative_path:
        return path
    else:
        return os.path.join(prefix,path)
...
#     label_path='/mnt/ChillDisk/personal_data/chenjh/dataset/Data/TJ4DRadSet/label_2/000025.txt'
#     annos=get_label_anno(label_path)