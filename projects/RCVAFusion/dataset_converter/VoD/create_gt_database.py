...
import projects.RCVAFusion.mmdet3d_plugin.datasets.VOD_dataset
...
def create_groundtruth_database(dataset_class_name,
    ...
    dataset_cfg = dict(
        ...
        data_root=data_path,
        modality=dict(use_lidar=True,use_radar=False,use_camera=False),
        point_type='use_lidar',
        ann_file=info_path,
        data_prefix=dict(pts_lidar='lidar/training/velodyne', img='lidar/training/image_2',pts_radar='radar/training/velodyne'),
        pipeline=[
            dict(
                type='LoadPointsFromVOD',
                coord_type='LIDAR',
                load_dim=4,
                modality='lidar',
                use_dim=[0,1,2,3],
